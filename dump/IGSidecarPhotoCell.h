...
@class IGFilteredImageView, IGImageFilter, IGMediaMetadata, NSString, UIButton, UIImage, UIImageView, UIView;

@interface IGSidecarPhotoCell : UICollectionViewCell <IGSidecarCellType>
{
    _Bool _disabled;
