...
- (id)initWithImage:(id)arg1 video:(id)arg2 backgroundColor:(id)arg3 scrollEnabled:(_Bool)arg4;
- (id)initWithImage:(id)arg1 video:(id)arg2 scrollEnabled:(_Bool)arg3;
- (void)layoutSubviews;
- (void)onTap:(id)arg1;
...
- (void)scaleFromView:(id)arg1 destinationSize:(struct CGSize)arg2 resetBlock:(CDUnknownBlockType)arg3;
