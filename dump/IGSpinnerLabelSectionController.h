...
@class IGSeparatorSupplementaryViewSource, IGSpinnerLabelViewModel, NSString;

@interface IGSpinnerLabelSectionController : IGListSectionController <IGListSectionType>
{
