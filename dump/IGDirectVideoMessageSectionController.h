...
@class IGDirectMessageItemComponents, IGDirectVideoMessageViewModel, NSString;

@interface IGDirectVideoMessageSectionController : IGListSectionController <IGDirectMediaViewerTransitionManagerDelegate, IGDirectMessageCellAvatarDelegate, IGDirectMessageCellDoubleTapLikeDelegate, IGListSectionType>
{
    IGDirectVideoMessageViewModel *_viewModel;
...
@property(readonly, nonatomic) IGDirectVideoMessageViewModel *viewModel; // @synthesize viewModel=_viewModel;
