...
@class IGSearchAsyncDataSource, IGSuggestedSearchDataSource, IGUserSession, NSArray, NSString;
...
@property(readonly, nonatomic) NSArray *frequentItems; // @synthesize frequentItems=_frequentItems;
