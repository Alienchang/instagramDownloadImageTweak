...
@class IGDirectMessageItemComponents, IGDirectPhotoMessageViewModel, NSString;

@interface IGDirectPhotoMessageSectionController : IGListSectionController <IGDirectMediaViewerTransitionManagerDelegate, IGDirectMessageCellAvatarDelegate, IGDirectMessageCellDoubleTapLikeDelegate, IGListSectionType>
{
    IGDirectPhotoMessageViewModel *_viewModel;
...
@property(readonly, nonatomic) IGDirectPhotoMessageViewModel *viewModel; // @synthesize viewModel=_viewModel;
