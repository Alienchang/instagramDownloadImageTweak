...
@class IGPhotoUploader, IGSidecarPhotoUploadAsset, NSArray, NSData, NSDictionary, NSProgress, NSString;

@interface IGSidecarPhotoUpload : NSObject <IGUploadable>
{
    IGSidecarPhotoUploadAsset *_uploadAsset;
    NSData *_renderedImageData;
